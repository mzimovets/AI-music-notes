...
function RaspberryIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="#e8457a" xmlns="http://www.w3.org/2000/svg">
        ...
        <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
          ...
          >
            <div className="flex items-center gap-1.5">
              ...
              {isLocal && (
                <span title="Подключено к Raspberry Pi" className="-translate-y-0.5 opacity-90">
                  <RaspberryIcon size={14} />
                </span>
              )}
            </div>
          </div>

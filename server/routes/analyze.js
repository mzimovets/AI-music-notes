...
async function analyzeWithClaude(songName, pdfText, webLyrics = null) {
  ...
  const lyricsInstruction = webLyrics
    ? "Поле lyrics заполни точным текстом из раздела «Текст песни, найденный в интернете» выше."
    : hasRealText
      ? "Поле lyrics заполни текстом из раздела «Текст из PDF» выше (может содержать ошибки нотации — исправь очевидные)."
      : "Поле lyrics оставь пустой строкой \"\". НЕ придумывай и НЕ угадывай текст песни — только оставь поле пустым.";

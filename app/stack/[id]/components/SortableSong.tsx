    ...
    <div ref={setNodeRef} style={style}>
      ...
      <Button
        ...
        <div className="flex flex-col overflow-hidden w-full">
          <p className="text-bold text-sm lg:text-base text-left input-header truncate">
            <span className="mr-2 text-default-400">{index + 1}.</span>
            {song.name}
          </p>
          <p className="text-left text-bold text-sm lg:text-base input-header justify-center text-default-500 truncate w-full">
            {song.author}
          </p>
        </div>
      </Button>

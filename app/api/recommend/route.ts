...
4. Раздели на секции: Разгрев / Середина / Финал.

Верни JSON:
{"rationale":"2-3 предложения о логике программы","recommendations":[{"name":"ТОЧНОЕ название из библиотеки","section":"Разгрев","reason":"почему эта песня подходит по контексту"}]}`;

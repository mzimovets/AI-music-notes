...
export async function updateStack({
  ...
  // Ревалидация здесь убрана намеренно. Она заставляла Next.js заново
  // отрендерить серверный layout, который сам ходит за стопкой, — во время
  // службы это давало паузу на каждое перетаскивание песни. Источник правды на
  // экране — локальное состояние и события сокета, в базу мы уже записали.
  return response;
}
